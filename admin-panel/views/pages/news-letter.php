              ...
              <div id="sidemenu-include">
               ...
               <div class="col m12 s12 l9">
                  <div class="main-bar">
                     ...
                     <div class="row">
                         <div class="col 12 m6">
                             <p class="h5-para black-text m0">Newsletter Subscribers</p>
                         </div>
                                    ...
                                    <tbody>
                                        <?php foreach($lists as $k => $row){ ?>
                                            <tr>
                                                ...
                                                <td class="center">
                                                   <div>
                                                      <a href="<?php echo base_url('news-letter/delete/').$row->id ?>" class="red btn-small action-btn  action-btn delete-btn" ><i class="fas fa-trash"></i></a>
                                                   </div>
                                                </td>
                                            </tr>
                                        <?php }?>
