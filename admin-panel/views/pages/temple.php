...
<html>
   ...
   <body>
                                        ...
                                        <div class="container-temple cnt">
                                            <div class="card">
                                                ...
                                                <div class="card-reveal">
                                                    <span class="card-title grey-text text-darken-4"><?php echo $temples->title ?><i class="fas fa-times right"></i></span>
                                                    <p><?php echo !empty($temples->content) ? $temples->content : '' ?></p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
    ...
    <div id="modal1" class="modal">
        <form action="<?php echo base_url() ?>temple/update" method="post" enctype="multipart/form-data">
        <div class="modal-content">
            <h6 class="bold">Change temple Article</h6>
            <br>
            <div class="row">
                <div class="col s12">
                    <span >Select temple Type </span>
                </div>
    ...
    <script>
        ...
        $(document).ready( function () {
            ...
            $('.container-temple .card-image a').click(function (e) { 
                ...
                $.ajax({
                    type: "post",
                    url: "<?php echo base_url() ?>temple/get_single_temple",
