                        ...
                        <div class="row m0 mb10 boder-bottom c-tabs">
                            ...
                            <div class="col l4 m4 s12">
                                <a href="<?php echo base_url() ?>post/scheduled-articles">
                                    <p class="black-text f-left m0"><i class="fas red-text fa-clock left " style="font-size:1.5rem"></i> Scheduled Articles</p>
                                </a>
                            </div>
                            <div class="col l4 m4 s12">
                        ...
                        <div class="col s12 m4 ">
                            <ul class="collapsible  popout">
                                ...
                                <li>
                                    ...
                                    <div class="collapsible-body">
                                        <div class="input-box">
                                            <input type="text" id="ptitle" name="ptitle" placeholder="title" class="validate" value="" onload="convertToSlug(this.value)" onkeyup="convertToSlug(this.value)" required="">
                                        </div>
                                        <div class="input-box">
    ...
    <script>
        $(document).ready(function() {
            ...
            var dataTable = $('#dynamic').DataTable({
                ...
                'order': [],
                'ajax': {
                    'url': "<?php echo base_url(). 'post/getScheduleData' ?>",
                    'type': 'POST'
                },
                'columnDefs': [{
                    "targets": [0],
