...
<p style="font-size: 22px; line-height: 1.2; mso-line-height-alt: 26px; margin: 0;"><span style="font-size: 22px;">Congratulations!</span></p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
...
<p style="font-size: 14px; line-height: 1.5; mso-line-height-alt: 21px; margin: 0;">You are receiving this message because you have added as Raja housing admin, please click the below button to activate your account by setting the password.</p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
...
<!--[if mso]><table width="100%" cellpadding="0" cellspacing="0" border="0" style="border-spacing: 0; border-collapse: collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;"><tr><td style="padding-top: 5px; padding-right: 10px; padding-bottom: 35px; padding-left: 10px" align="left"><v:roundrect xmlns:v="urn:schemas-microsoft-com:vml" xmlns:w="urn:schemas-microsoft-com:office:word" href="" style="height:31.5pt; width:165pt; v-text-anchor:middle;" arcsize="120%" stroke="false" fillcolor="#FFD500"><w:anchorlock/><v:textbox inset="0,0,0,0"><center style="color:#132F40; font-family:Arial, sans-serif; font-size:15px"><![endif]-->
  <a href="<?php echo base_url().'email-verification?regid='.$result['reference_d'].'&regmail='.$result['email'] ?>">
...
<p style="font-size: 12px; line-height: 1.2; mso-line-height-alt: 17px; margin: 0;">© <?php echo date('Y') ?> <a href="<?php echo base_url() ?>" style="color: white;"> Raja Housing </a> All rights reserved.</p>
</div>
</div>
<!--[if mso]></td></tr></table><![endif]-->
<!--[if (!mso)&(!IE)]><!-->
