                    ...
                    <div class="col m12 s12 l9">
                        <div class="card main-bar">
                            <div class="card-content">
                                <form action="<?php echo base_url('subadmin/add') ?>"  method="post"  id="author_form" enctype="multipart/form-data">
                                    <div class="row m0">
                                        <h6 class="m-title col s12">Add Subadmin</h6><br>
                                        <div class="input-field col s12 m6">
                                            <input type="text" id="name" name="name" class="validate" autofocus required>
                                            <label for="name">Name <span class="red-text">*</span></label>
                                            <input type="hidden" id="uniq" name="uniq" value="<?php echo random_string('alnum',16) ?>">
                                        </div>
                                        <div class="input-field col s12 m6">
                                        ...
                                        <div class="input-field col s12 m6">
                                            <input type="number" id="phone" name="phone" class="validate"  required maxlength="10">
