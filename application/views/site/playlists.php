                        ...
                        <div class="sidebar">
                            ...
                            <div class="widget social-widget">
                                ...
                                <ul class="social-share">
                                    <li>
                                        <a href="https://www.facebook.com/mahonnathikannada/" class="facebook"><i
                                                class="fa fa-facebook"></i></a>
                                        <span class="number">Facebook</span>
                                        <!-- <span>Facebook</span> -->
                                    </li>
                                    <li>
                                        <a href="https://twitter.com/mahonnathikan" class="twitter"><i
...
" class="google"><i class="fa fa-youtube"></i></a>
                                    ...
                                    <li>
                                        <a href="https://www.instagram.com/mahonnathikannada/" class="rss"><i
                                                        ...
                                                        <div class="hover-box">
                                                            <div class="inner-hover">
                                                                <h2><a href="<?php echo $urllink ?>">
                                                                        <?php echo word_limiter(strip_tags($ttle), 5).'...' ?></a>
                                                                </h2>
                                                                <ul class="post-tags">
                                                                    <!--  -->
                            ...
                            <div class="widget">
                                <a href="http://www.mindvik.com/" target="_blank">
                                    <img src="<?php echo base_url() ?>assets/images/ad-img3.png" class="img-responsive"
                                        alt=""></a>
                            </div>
                            ...
                            <div class="widget">
                                <a href="http://www.5ines.com/" target="_blank">
                                    <img src="<?php echo base_url() ?>assets/images/ad-img4.png" class="img-responsive"
                                        alt=""></a>
                            </div>
                            <div class="widget">
                                <a href="http://www.getmyappz.com/" target="_blank">
                                    <img src="<?php echo base_url() ?>assets/images/ad-img5.jpg" class="img-responsive"
                                        alt=""></a>
                            </div>
                            ...
                            <div class="widget post-widget">
                                ...
                                <div>
                                    <div class="news-post video-post">
                                        <a
                                            href="<?php echo strtolower(base_url('videos/').$value->category.'/'.$value->slug) ?>"><img
                                                alt="" src="<?php echo $value->tumb ?>"></a>
                                        <a href="<?php echo strtolower(base_url('videos/').$value->category.'/'.$value->slug )?>"
                                            class="video-icon"><i class="fa fa-play-circle-o"></i></a>

                                    </div>
                                    <p><a
                                            href="<?php echo strtolower(base_url('videos/').$value->category.'/'.$value->slug) ?>"><?php echo word_limiter(strip_tags($value->title), 3).'...' ?></a>
                                    </p>
                                </div>
                                <?php } ?>
                            </div>
                        ...
                        <div class="block-content">
                            ...
                            <div class="article-box">
                                <div class="title-section">
									...
									if(!empty($playlists)){
										echo (!empty($post[0]->kannada)? '<h1><span class="world">'.$post[0]->kannada.'</span></h1>': '<h1><span class="world">Playlist</span></h1>');
									}else{
                                ...
                                <div class="news-post article-post">
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <a href="<?php echo $this->urls->urlFormat(base_url('playlist/detail/').$play->pl_slug.'/'.$play->slug) ?>">
                                                <div class="post-gallery c-post-gallery pl-blur">
                                                    <img alt="" src="<?php echo base_url().$play->image ?>">
                                        ...
                                        <div class="col-sm-6">
                                            <div class="post-content">
                                                <h2><a
                                                        href="<?php echo $this->urls->urlFormat(base_url('playlist/').$play->pl_slug.'/detail/'.$play->slug) ?>"><?php echo $play->title ?></a>
                                                </h2>


                                                <a href="<?php echo $this->urls->urlFormat(base_url('playlist/').$play->pl_slug.'/detail/'.$play->slug)  ?>"
                                                    class="read-more-button"><i
                                                        class="fa fa-arrow-circle-right"></i>View </a>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="error-banner">
                                    ...
                                    <p>Oops! It looks like nothing was found at this search. Maybe try another search?
                                    </p>
                                </div>
                    ...
                    <div class="col-sm-2">
                        <div class="right-inside-add sidebar">
                            ...
                            <div class="widget">
                                <img src="http://www.winchesteril.com/wp-content/uploads/2017/10/ad-placeholder.jpg"
                            ...
                            <div class="widget">
                                <a href="http://www.mindvik.com/" target="_blank">
                                    <img src="<?php echo base_url() ?>assets/images/ad-img2.jpg" class="img-responsive"
                                        alt=""></a>
                            </div>
                            <div class="widget">
                                <a href="http://www.mindvik.com/" target="_blank">
                                    <img src="<?php echo base_url() ?>assets/images/ad-img7.png" class="img-responsive"
                                        alt=""></a>
                            </div>
                            <div class="widget">
                                <a href="<?php echo base_url() ?>" target="_blank">
                                    <img src="<?php echo base_url() ?>assets/images/ad-img6.jpg" class="img-responsive"
                                        alt=""></a>
                            </div>
                            <div class="advertisement">
                                <div class="desktop-advert">
                                    <span>Advertisement</span>
                                    <a href="<?php echo base_url() ?>" target="_blank">
                                        <img src="<?php echo base_url() ?>assets/images/ad-img8.png"
                                            class="img-responsive" alt=""></a>
                                </div>
                                <div class="tablet-advert">
                                    <span>Advertisement</span>
                                    <img src="<?php echo base_url() ?>assets/upload/addsense/200x200.jpg"
                                        class="img-responsive" alt="">
                                </div>
                                <div class="mobile-advert">
                                    <span>Advertisement</span>
