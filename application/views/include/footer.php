<footer>
			<div class="container">
				<div class="footer-widgets-part">
					<div class="row">
						<div class="col-md-3">
						<a href="<?php echo base_url() ?>"><img style="width:100%; margin-top:50px" src="<?php echo base_url() ?>assets/images/footer-logo.png" alt="mahonnathi" class="img-responsive"></a>
						</div>
						<div class="col-md-3">
