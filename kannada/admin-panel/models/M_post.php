...
class m_post extends CI_Model {
...

	{
		...
		$select_column = array("p.id","p.tags", "p.title", "p.slug", "c.title as category", 'p.date', 'a.name as posted_by', 'p.created_on','pl.title as playlist');  
...
*/
   ...
   function get_schedule_filtered_data(){  
    ...
    public function postedById($id)
    {
        return $this->db->where('id',$id)->select('posted_by')->get('mh_posts')->row()->posted_by;
    }
