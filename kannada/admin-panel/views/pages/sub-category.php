                                 ...
                                 <div class="collapsible-header h4 col-btn">
                                    <span class="left">
                                       ...
                                       <!-- <a href="#!" class="right red-text  ">
                                          <i class="material-icons m0">delete</i>
                                       </a>
                                       <a href="#!" class="right blue-text  ">
                                          <i class="material-icons m0">edit</i>
                                       </a> -->
                                       <a class="right green-text add-btn  modal-trigger" href="#modal1" data-id="<?php echo $value->id?>">
