                    ...
                    <div class="card-content">
                        ...
                        <form  id="newsPost">
                                        ...
                                        <ul class="collapsible  popout">
                                            ...
                                            <li>
                                                <div class="collapsible-header"><i
                                                    ...
                                                    <p>
                                                        <label>
                                                            <input data_val="<?php echo $value->title;?>"  value="<?php echo $value->id;?>" class="with-gap" class="main-categoris" name="playlist_id" type="radio" <?php if($post->playlist_id==$value->id){echo 'checked';} ?> />
                            ...
                            <div class="modal-footer mt10">
                                ...
                                <a href="<?php echo base_url('playlist-article/').$playlist_id ?>" class="modal-close waves-effect waves-red hoverable red btn-small btn">Close <i class="fas fa-times right"></i></a>
                            </div>
                        </form>
                    ...
                    $.ajax({
                        ...
                        if(data.status == true){
                            ...
                            if($('input[name=btnType]').val() == 'preview'){
                                ...
                                $('#img-previwer').attr('src', '');
                                clearform(); 
                                window.location.href = "<?php echo base_url('playlist-article/').$playlist_id ?>";
                            }
                        }else{
                            M.toast({
                                html: data.msg,
