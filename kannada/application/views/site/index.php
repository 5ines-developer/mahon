...
<script>
                        ...
                        <div class="hover-box">
                            ...
                            <div class="inner-hover">
                                ...
                                <p>
                                    ...
                                    <?php echo word_limiter(strip_tags($content), 4).'...' ?>
                            ...
                            <div class="hover-box">
                                ...
                                <div class="inner-hover">
                                    ...
                                    <p>
                                        ...
                                        <?php echo word_limiter(strip_tags($content), 8).'...' ?>
                        ...
                        <div class="hover-box">
                            ...
                            <div class="inner-hover">
                                ...
                                <p>
                                    ...
                                    <?php echo word_limiter(strip_tags($content), 5).'...' ?>
    ...
    <div class="col-md-7 col-sm-8 content-blocker brd">
        ...
        <div class="block-content">
                                    ...
                                    <div class="post-gallery">
                                        ...
                                        <div class="hover-box overlaybox">
                                            ...
                                            <div class="inner-hover">
                                                ...
                                                <h2><a href="<?php echo $urllink ?>"><?php echo word_limiter(strip_tags($fetured[0]->title), 4).'...' ?></a></h2>
                                                ...
                                                <ul class="post-tags">
                                                    ...
                                                    <?php 
																	...
																	echo (!empty($fetured[0]->posted_by)? '<li style="display:block"><i class="fa fa-user"></i>by <a href="#!">'.$fetured[0]->posted_by .'</a></li>' : '' )
                                ...
                                <div class="post-content">
                                    ...
                                    <h2>
                                        ...
                                        <a href="<?php echo $urllink ?>">
                                            ...
                                            <?php echo word_limiter(strip_tags($row->title), 4).'...' ?>
            ...
            <!--playlist carousel box -->
            <div class="carousel-box owl-wrapper graydlayer">
                <div class="title-section">
                    <h1><span>ಕಥಾಸರಣಿ</span></h1>
                </div>
                ...
                <?php foreach($playlists as $key => $row) { ?>
                    ...
                    <div class="item news-post standard-post">
                        ...
                        <div >
                           <h2 style="font-size:14px;margin:0px;">ಒಟ್ಟು ಕಥೆಗಳು :  <?php  if(!empty($row->playlist_id)){echo  playlistCount($row->playlist_id);};?></h2>
                                ...
                                <div class="post-content">
                                    ...
                                    <h2>
                                        ...
                                        <a href="<?php echo base_url('photogallery/').strtolower($image->category.'/'.$image->slug) ?>">
                                            ...
                                            <?php echo word_limiter(strip_tags($image->title), 4).'...' ?>
                                            ...
                                            <div class="inner-hover">
                                                ...
                                                <h2>
                                                    ...
                                                    <a href="<?php echo $urllink ?>">
                                                        ...
                                                        <?php echo word_limiter(strip_tags($tprow->title), 4).'...' ?>
                                ...
                                <div class="post-content">
                                    ...
                                    <h2>
                                        ...
                                        <a href="<?php echo $urllink ?>">
                                            ...
                                            <?php echo word_limiter(strip_tags($prow->title), 4).'...' ?>
